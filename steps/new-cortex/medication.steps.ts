...
import { MedicationTestCase } from '../../data/medication.data';

export class MedicationSteps {
  ...
  // ─── Dynamic Entry Point ───────────────────────────
  async execute(tc: MedicationTestCase) {
    // ── Given ──
  ...
  // ─── Action Dispatcher ─────────────────────────────
  private async dispatchAction(tc: MedicationTestCase) {
  ...
  // ─── Expect Dispatcher ─────────────────────────────
  private async dispatchExpect(tc: MedicationTestCase) {
    switch (tc.expect) {
