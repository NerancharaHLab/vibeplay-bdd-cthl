...
export class RegistrationNewCortexSteps {
  ...
  async execute(tc: RegistrationSbhTestCase) {
    // ── Given ── login to New Cortex and open patient search/registration
    await this.auth.givenUserIsLoggedInAs(tc.role, 'new-cortex');
    await this.nav.navigateToModule('/cortex/medical-record');
