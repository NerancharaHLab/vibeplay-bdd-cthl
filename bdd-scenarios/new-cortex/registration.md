...
> โครงการนี้พัฒนาการทดสอบด้วยสถาปัตยกรรมไดนามิก ครอบคลุมเคสทดสอบทั้งหมด **74 รายการ** โดยชุดทดสอบจะทำการโหลดเคสโดยตรงจากไฟล์คอนฟิกข้อมูล [registration-sbh.data.ts](file:///Users/neranchara/Jobs/Project/VibeCode_Automate_Test_ Playwright_BDD/data/registration-sbh.data.ts) เพื่อรันและรายงานผลอย่างเป็นระบบโดยไม่ต้องมีสคริปต์แยกของแต่ละเคส
