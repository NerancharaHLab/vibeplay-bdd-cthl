# BDD Scenarios: Registration (New Cortex)

พื้นที่สำหรับทีม QA ในการดูตัวอย่าง ออกแบบ และบันทึกเคสทดสอบรูปแบบ Given-When-Then ของระบบเวชระเบียนและสร้างประวัติผู้ป่วยใหม่ (Registration) ไซต์ New Cortex
...
> โครงการนี้พัฒนาการทดสอบด้วยสถาปัตยกรรมไดนามิก ครอบคลุมเคสทดสอบทั้งหมด **74 รายการ** โดยชุดทดสอบจะทำการโหลดเคสโดยตรงจากไฟล์คอนฟิกข้อมูล [registration.data.ts](file:///Users/neranchara/Jobs/Project/vibeplay-bdd-cthl/data/registration.data.ts) เพื่อรันและรายงานผลอย่างเป็นระบบโดยไม่ต้องมีสคริปต์แยกของแต่ละเคส
