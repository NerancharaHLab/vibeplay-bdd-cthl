...
Call log:
  - navigating to "https://dev-x.cortexcloud.co/cortex/welcome", waiting until "load"
...
```ts
  ...
  18 | 
  19 |   async goto() {
> 20 |     await this.page.goto('/cortex/welcome');
     |                     ^ TimeoutError: page.goto: Timeout 30000ms exceeded.
  21 |   }
  22 | 
  ...
  42 |     await this.usernameInput.waitFor({ state: 'visible', timeout: 20000 });
